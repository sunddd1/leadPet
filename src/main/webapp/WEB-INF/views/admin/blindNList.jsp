...
<button onclick="location.href='reportList'">글 신고 리스트 DEMO</button>
    ...
    <div id="search2">
        <input type="text" id="NSearch" value="${keyword}" name="keyword" placeholder="닉네임을 입력하세요">
...
<script>
	...
	$('#searchBtn').click(function() {
		...
		console.log(NSearch);
		location.href="./blindNList?keyword="+NSearch;
	});
		...
		function listPrint(list){
			...
			for(var i=0;i<list.length;i++){
				...
				content +="<td><button value='"+list[i].bbs_idx+"' onclick='toggleDisable(this)'>블라인드 추가</button>"
				content += '</tr>';
			}
